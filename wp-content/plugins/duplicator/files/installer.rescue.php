...
<div id="content">
	...
	if ($action == 'process') {
		...
		dinstaller_log("secure build name: 5044db9138ba81684_package");
		dinstaller_log("----------------------------------");
...
HTACCESS;
	...
	<?php if  ($action == null) : ?>
		...
		<form id="form-installer" action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post" >
			...
			<table width="100%" border="0" cellspacing="2" cellpadding="2"  class="table-inputs">
				<tr><td style="width:130px">Host</td><td><input type="text" name="dbhost" id="dbhost" value="" /></td></tr>
